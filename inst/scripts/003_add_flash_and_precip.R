...
# Add flash data
#--DON'T RUN--- caution: raw file needed for the next lines is not provided as it is owned by ALDIS. Processed stationwise flash data (as produced by this script, see below) is provided in this repository
